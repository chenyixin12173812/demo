...
## 1.5  [1423. 可获得的最大点数](https://leetcode-cn.com/problems/maximum-points-you-can-obtain-from-cards/)
...
# 2 使用HashMap维护不是dp[]
 ...
 ![](https://pic.leetcode-cn.com/1610772571-ENbfIz-%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20210116124856.jpg
...
## 2.1 560. 和为K的子数组(最经典问题) 930 和相同的二元子数组
...
![1612614968405](4 DP.assets/1612614968405.png)
    ...
    public int findMaxLength(int[] nums) {
     ...
     for(int i=0;i<nums.length;i++) {
        ...
        if(map.containsKey(pre-0)) {
            cunt =Math.max(cunt,i- map.get(pre-0));
        } else{
          map.put(pre,i); 
        } 
